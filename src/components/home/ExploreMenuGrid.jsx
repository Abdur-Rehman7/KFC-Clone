  ...
  return (
    <div className="w-full mx-auto">
      <div className="grid grid-cols-3 grid-rows-2 gap-4 sm:gap-5">
        {/* 01 — Tall Left Card */}
        <div className="row-span-2 flex flex-col justify-between border border-dashed border-text rounded-[10px] p-3 shadow-sm h-[300px] sm:h-[320px]">
        ...
        {/* 02 — Top Row Middle */}
        <div className="flex flex-col justify-between border border-dashed border-text rounded-[10px] p-3 shadow-sm h-[140px] md:h-[150px]">
          <p className="text-[14px] sm:text-[16px] font-semibold mb-2">
            {menuItems[1].text}
          </p>
          <img
