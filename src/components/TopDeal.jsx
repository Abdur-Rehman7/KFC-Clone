...
const TopDeal = (props) => {
  ...
  return (
    <div className="w-[300px] h-[454px] bg-surface relative rounded-lg overflow-visible shadow-sm group">
      {/* Top bars */}
      <div className="pt-[15px] px-[5px] pb-[35px] mx-auto">
        ...
        <div className="overflow-hidden rounded-md">
          <img
            className="w-[286px] h-[286px] object-contain transition-transform duration-500 ease-in-out group-hover:scale-105"
            src={props.img}
            alt={props.name}
          />
        </div>
